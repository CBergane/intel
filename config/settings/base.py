...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "intel.navigation.navigation_context",
            ],
        },
    },
]
...
DARK_TOR_SOCKS_URL = os.getenv("DARK_TOR_SOCKS_URL", "socks5h://127.0.0.1:9050")
DARK_FETCH_TIMEOUT = int(os.getenv("DARK_FETCH_TIMEOUT", "20"))
