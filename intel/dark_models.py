...
class DarkHit(models.Model):
    ...
    alert_identity_hash = models.CharField(max_length=64, blank=True, db_index=True)
    last_alert_fingerprint = models.CharField(max_length=64, blank=True)
    last_alerted_at = models.DateTimeField(null=True, blank=True, db_index=True)
